...
namespace CinemaA.Migrations
{
    ...
    [Migration("20200921144327_Renewing")]
    partial class Renewing
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaA.Models.Session", b =>
                {
                    b.HasOne("CinemaA.Models.Film", "Film")
                        .WithMany("Sessions")
                        .HasForeignKey("IdFilm")
                        .HasConstraintName("FK_Session_ToFilm")
                        .IsRequired();

                    b.HasOne("CinemaA.Models.Hall", "Hall")
                        .WithMany("Sessions")
            ...
            modelBuilder.Entity("CinemaA.Models.Ticket", b =>
                {
                    b.HasOne("CinemaA.Models.Session", "Session")
                        .WithMany("Tickets")
